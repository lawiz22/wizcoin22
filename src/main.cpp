...
uint256 hashGenesisBlock("0xe16a0ed36171a41ccab3fc2635f1df3c97a45a2c24fcf1bfd6bc7ecfc7de07de");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    int64 nSubsidy = 2222 * COIN;
	int diffSettlingPeriod = 22000;

	if(nHeight < diffSettlingPeriod) {
		nSubsidy = 22222 * COIN; //small reward while waiting for initial diff to settle.
	}
...
static const int64 nTargetTimespan = 60 * 60 * 4; // Wizcoin: 4 hours
static const int64 nTargetSpacing = 120; // Wizcoin: 2 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xb6159ed9fab8967553307c0ef209da6cf9a705b5525b06a7402e6e5d8924fa6d");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        assert(block.hashMerkleRoot == uint256("0x69c0831583cbb49dbfe155b85d3a4d244f790224d0dd4abb9c21221204af2ec8"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Wizcoin: increase each by adding 2 to bitcoin's value.
