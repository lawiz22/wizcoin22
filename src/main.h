...
static const int64 DUST_SOFT_LIMIT = 100000000; // 1 WIZ
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000000;   // 0.01 WIZ mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 22222222222 * COIN; //No reasonable tx should be over 50 billion, even with inflation. 
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 100 * COIN * 720 / 250; //Wizcoin: 720 blocks per day at 100 WIZ cutoff.
    }
